...
*   **Data**:
   ...
   **Figure Generation**:
    *   `figure2AE.m`: Recreates some panels for Figure 2 (dose response plots).
    *   `figure2BCDFGH.m`: Recreates some panels for Figure 2 (surface plots).
...
*   **Key Scripts**: `norm_MCF7_Doxo.m`, `norm_MCF7_Pacli.m`, `norm_T47D_Pacli.m`. These use linear models to map fluorescence to cell numbers based on standard curves.
    *   These scripts are called by functions in the other folders, including EGA and Validation.
