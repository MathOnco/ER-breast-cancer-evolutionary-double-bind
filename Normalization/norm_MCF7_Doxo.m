...
cell_counts = xlsread('./MCF7_Sens&DoxoR.xlsx',1,'D2:K2');
YFPdata = xlsread('./MCF7_Sens&DoxoR.xlsx',1,'D3:K5');
RFPdata = xlsread('./MCF7_Sens&DoxoR.xlsx',1,'L18:S20');
[n,~]=size(YFPdata);
...
color_indices = xlsread('../Normalization/MCF7_Sens&DoxoR.xlsx',1,'T3:T20');
cell_counts = xlsread('../Normalization/MCF7_Sens&DoxoR.xlsx',1,'D2:K2');
YFP = xlsread('../Normalization/MCF7_Sens&DoxoR.xlsx',1,'D3:K17');
RFP = xlsread('../Normalization/MCF7_Sens&DoxoR.xlsx',1,'L6:S20');
[n,~]=size(YFP);
...
title('MCF7 Doxo Resistance')

% printPNG(figure(1),'ValidationPlots/MCF7_DoxoR.png');
